...
Shader "ShaderGraphBasics/Cloth"
{
	Properties
	{
		...
		_OuterFalloff("OuterFalloff", Float) = 3
		_OuterBrightness("OuterBrightness", Float) = 1.5
		_InnerFalloff("InnerFalloff", Float) = 1
		[ASEEnd]_InnerBrightness("InnerBrightness", Float) = 0.5
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float dotResult17 = dot( WorldViewDirection , IN.ase_normal );
				float fresnel31 = ( ( pow( ( 1.0 - dotResult17 ) , _OuterFalloff ) * _OuterBrightness ) + ( pow( dotResult17 , _InnerFalloff ) * _InnerBrightness ) );
				float2 temp_cast_0 = (_Tiling).xx;
				float2 texCoord29 = IN.ase_texcoord8.xy * temp_cast_0 + float2( 0,0 );
				float4 baseColor36 = ( fresnel31 * tex2D( _BaseMap, texCoord29 ) );
				
				float3 unpack28 = UnpackNormalScale( tex2D( _BumpMap, texCoord29 ), _BumpScale );
				unpack28.z = lerp( 1, unpack28.z, saturate(_BumpScale) );
				float3 normal37 = ( fresnel31 * unpack28 );
				

				float3 BaseColor = baseColor36.rgb;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float dotResult17 = dot( ase_worldViewDir , IN.ase_normal );
				float fresnel31 = ( ( pow( ( 1.0 - dotResult17 ) , _OuterFalloff ) * _OuterBrightness ) + ( pow( dotResult17 , _InnerFalloff ) * _InnerBrightness ) );
				float2 temp_cast_0 = (_Tiling).xx;
				float2 texCoord29 = IN.ase_texcoord4.xy * temp_cast_0 + float2( 0,0 );
				float4 baseColor36 = ( fresnel31 * tex2D( _BaseMap, texCoord29 ) );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float fresnel31 = ( ( pow( ( 1.0 - dotResult17 ) , _OuterFalloff ) * _OuterBrightness ) + ( pow( dotResult17 , _InnerFalloff ) * _InnerBrightness ) );
				float2 temp_cast_0 = (_Tiling).xx;
				float2 texCoord29 = IN.ase_texcoord2.xy * temp_cast_0 + float2( 0,0 );
				float4 baseColor36 = ( fresnel31 * tex2D( _BaseMap, texCoord29 ) );
...
/*ASEBEGIN
Version=19105
Node;AmplifyShaderEditor.CommentaryNode;26;-1239.756,306.1017;Inherit;False;751.7885;398.5581;Inner Fresnel;4;21;22;23;24;;1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;25;-1247.694,-120.8976;Inherit;False;784.7424;398.5583;Outer Fresnel;5;12;13;14;18;19;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.OneMinusNode;12;-1197.694,-62.61058;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;13;-996.1822,-70.89764;Inherit;True;False;2;0;FLOAT;0;False;1;FLOAT;2;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;14;-697.9528,-70.05623;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;21;-1021.197,356.1017;Inherit;True;False;2;0;FLOAT;0;False;1;FLOAT;2;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;22;-722.9694,356.9431;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;23;-1189.756,469.66;Inherit;False;Property;_InnerFalloff;InnerFalloff;7;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.DotProductOpNode;17;-1506.653,245.6438;Inherit;True;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.NormalVertexDataNode;16;-1740.653,313.6437;Inherit;False;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ViewDirInputsCoordNode;10;-1729.82,153.6798;Inherit;False;World;True;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.TextureCoordinatesNode;29;-1496.574,980.0101;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;27;-1219.674,843.5103;Inherit;True;Property;_BaseMap;BaseMap;1;1;[NoScaleOffset];Create;True;0;0;0;False;0;False;-1;957eb156e848a1a4f9395e13062a34f7;957eb156e848a1a4f9395e13062a34f7;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;32;-724.2756,936.8971;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;33;-905.1625,842.6494;Inherit;False;31;fresnel;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;34;-730.7189,1142.773;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;35;-911.6058,1048.526;Inherit;False;31;fresnel;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;36;-553.1625,937.6494;Inherit;False;baseColor;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;37;-544.1625,1144.649;Inherit;False;normal;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;38;327.365,214.0062;Inherit;False;36;baseColor;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;39;331.399,300.7355;Inherit;False;37;normal;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;531.6671,234.3152;Float;False;True;-1;2;UnityEditor.ShaderGraphLitGUI;0;12;ShaderGraphBasics/Cloth;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;19;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForward;False;False;0;;0;0;Standard;41;Workflow;1;0;Surface;0;0;  Refraction Model;0;0;  Blend;0;0;Two Sided;1;0;Fragment Normal Space,InvertActionOnDeselection;0;0;Forward Only;0;0;Transmission;0;0;  Transmission Shadow;0.5,False,;0;Translucency;0;0;  Translucency Strength;1,False,;0;  Normal Distortion;0.5,False,;0;  Scattering;2,False,;0;  Direct;0.9,False,;0;  Ambient;0.1,False,;0;  Shadow;0.5,False,;0;Cast Shadows;1;638263392152066609;  Use Shadow Threshold;0;0;Receive Shadows;1;638263392254288310;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;_FinalColorxAlpha;0;0;Meta Pass;1;0;Override Baked GI;0;0;Extra Pre Pass;0;0;DOTS Instancing;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Write Depth;0;0;  Early Z;0;0;Vertex Position,InvertActionOnDeselection;1;0;Debug Display;0;0;Clear Coat;0;0;0;10;False;True;True;True;True;True;True;True;True;True;False;;False;0
Node;AmplifyShaderEditor.SimpleAddOpNode;15;-397.5569,249.8454;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;28;-1218.373,1055.41;Inherit;True;Property;_BumpMap;BumpMap;2;1;[NoScaleOffset];Create;True;0;0;0;False;0;False;-1;e65155d75d2065e4da372f3e963fd4ce;e65155d75d2065e4da372f3e963fd4ce;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;42;-1425.026,1137.496;Inherit;False;Property;_BumpScale;BumpScale;3;0;Create;True;0;0;0;False;0;False;1;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;30;-1687.675,1000.81;Inherit;False;Property;_Tiling;Tiling;0;0;Create;True;0;0;0;False;0;False;4;4;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;24;-971.1583,588.6598;Inherit;False;Property;_InnerBrightness;InnerBrightness;8;0;Create;True;0;0;0;False;0;False;0.5;0.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;41;355.816,390.1118;Inherit;False;Property;_Smoothness;Smoothness;4;0;Create;True;0;0;0;False;0;False;0.2;0.1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;31;-93.37053,233.0449;Inherit;False;fresnel;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;18;-1164.741,42.66071;Inherit;False;Property;_OuterFalloff;OuterFalloff;5;0;Create;True;0;0;0;False;0;False;3;3;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;19;-909.7416,161.6607;Inherit;False;Property;_OuterBrightness;OuterBrightness;6;0;Create;True;0;0;0;False;0;False;1.5;1.5;0;0;0;1;FLOAT;0
...
WireConnection;28;5;42;0
WireConnection;31;0;15;0
ASEEND*/
//CHKSM=D1B6DDB3E1B087350068EA0158B454DE6E0235BD