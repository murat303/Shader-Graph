...
Shader "ShaderGraphBasics/PBRPacked"
{
	Properties
	{
		...
		_MetallicStrength("MetallicStrength", Float) = 0
		_OcclusionStrength("OcclusionStrength", Float) = 1
		_HeightScale("HeightScale", Float) = 0.05
		[ASEEnd]_SmoothnessStrength("SmoothnessStrength", Float) = 1
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 texCoord58 = IN.ase_texcoord8.xy * _Tiling + float2( 0,0 );
				float2 mainUV59 = texCoord58;
				float3 tanToWorld0 = float3( WorldTangent.x, WorldBiTangent.x, WorldNormal.x );
				float3 tanToWorld1 = float3( WorldTangent.y, WorldBiTangent.y, WorldNormal.y );
				float3 tanToWorld2 = float3( WorldTangent.z, WorldBiTangent.z, WorldNormal.z );
				float3 ase_tanViewDir =  tanToWorld0 * WorldViewDirection.x + tanToWorld1 * WorldViewDirection.y  + tanToWorld2 * WorldViewDirection.z;
				ase_tanViewDir = normalize(ase_tanViewDir);
				float2 paralaxOffset64 = ParallaxOffset( SAMPLE_TEXTURE2D( _HeightMap, sampler_Trilinear_Repeat_Aniso4, mainUV59 ).b , _HeightScale , ase_tanViewDir );
				float2 heightUV77 = ( mainUV59 + paralaxOffset64 );
				
				float3 unpack19 = UnpackNormalScale( SAMPLE_TEXTURE2D( _BumpMap, sampler_Trilinear_Repeat_Aniso4, heightUV77 ), _BumpScale );
				unpack19.z = lerp( 1, unpack19.z, saturate(_BumpScale) );
				
				float4 tex2DNode55 = SAMPLE_TEXTURE2D( _Mask, sampler_Trilinear_Repeat_Aniso4, heightUV77 );
				

				float3 BaseColor = SAMPLE_TEXTURE2D( _BaseMap, sampler_Trilinear_Repeat_Aniso4, heightUV77 ).rgb;
				float3 Normal = unpack19;
				float3 Emission = 0;
				float3 Specular = 0.5;
				float Metallic = ( _MetallicStrength * tex2DNode55.r );
				float Smoothness = ( _SmoothnessStrength * ( 1.0 - tex2DNode55.a ) );
				float Occlusion = pow( tex2DNode55.g , _OcclusionStrength );
				float Alpha = 1;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 texCoord58 = IN.ase_texcoord4.xy * _Tiling + float2( 0,0 );
				float2 mainUV59 = texCoord58;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 texCoord58 = IN.ase_texcoord2.xy * _Tiling + float2( 0,0 );
				float2 mainUV59 = texCoord58;
...
/*ASEBEGIN
Version=19105
Node;AmplifyShaderEditor.CommentaryNode;79;-2811.77,-158.3254;Inherit;False;1337.639;535.8369;;9;64;72;73;74;76;71;77;70;78;HeightMap;1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;63;-2064.542,-589.3426;Inherit;False;741.313;217.4067;;3;57;58;59;Main UV;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;0,0;Float;False;True;-1;2;UnityEditor.ShaderGraphLitGUI;0;12;ShaderGraphBasics/PBRPacked;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;19;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForward;False;False;0;;0;0;Standard;41;Workflow;1;0;Surface;0;638257367732567284;  Refraction Model;0;0;  Blend;0;0;Two Sided;1;0;Fragment Normal Space,InvertActionOnDeselection;0;0;Forward Only;0;0;Transmission;0;0;  Transmission Shadow;0.5,False,;0;Translucency;0;0;  Translucency Strength;1,False,;0;  Normal Distortion;0.5,False,;0;  Scattering;2,False,;0;  Direct;0.9,False,;0;  Ambient;0.1,False,;0;  Shadow;0.5,False,;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;_FinalColorxAlpha;0;0;Meta Pass;1;0;Override Baked GI;0;0;Extra Pre Pass;0;0;DOTS Instancing;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Write Depth;0;0;  Early Z;0;0;Vertex Position,InvertActionOnDeselection;1;0;Debug Display;0;0;Clear Coat;0;0;0;10;False;True;True;True;True;True;True;True;True;True;False;;True;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;53;-316.6531,40.59289;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;29;-542.1947,-16.49928;Inherit;False;Property;_MetallicStrength;MetallicStrength;6;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;10;-659.5663,-501.1248;Inherit;True;Property;_BaseMap;BaseMap;1;1;[NoScaleOffset];Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;15;-357.4732,213.6304;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;22;-590.3402,164.8739;Inherit;False;Property;_SmoothnessStrength;SmoothnessStrength;9;0;Create;True;0;0;0;False;0;False;1;0.75;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;21;-378.9244,415.9841;Inherit;False;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;13;-568.5858,244.4048;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;19;-657.5099,-300.7564;Inherit;True;Property;_BumpMap;BumpMap;2;1;[NoScaleOffset];Create;True;0;0;0;False;0;False;-1;None;None;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;20;-865.0926,-205.5954;Inherit;False;Property;_BumpScale;BumpScale;5;0;Create;True;0;0;0;False;0;False;1;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;61;-873.5001,-285.3562;Inherit;False;77;heightUV;1;0;OBJECT;;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;59;-1547.229,-539.3426;Inherit;False;mainUV;-1;True;1;0;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.Vector2Node;57;-2014.542,-532.9359;Inherit;False;Property;_Tiling;Tiling;0;0;Create;True;0;0;0;False;0;False;1,1;2,2;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.SamplerNode;55;-1163.855,65.52019;Inherit;True;Property;_Mask;Mask;3;1;[NoScaleOffset];Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;18;-615.2961,439.5678;Inherit;False;Property;_OcclusionStrength;OcclusionStrength;7;0;Create;True;0;0;0;False;0;False;1;3;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerStateNode;65;-2060.12,-736.4707;Inherit;False;0;0;0;2;-1;X4;1;0;SAMPLER2D;;False;1;SAMPLERSTATE;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;66;-1851.282,-733.6863;Inherit;False;ss;-1;True;1;0;SAMPLERSTATE;;False;1;SAMPLERSTATE;0
Node;AmplifyShaderEditor.GetLocalVarNode;68;-871.1348,-123.8783;Inherit;False;66;ss;1;0;OBJECT;;False;1;SAMPLERSTATE;0
Node;AmplifyShaderEditor.GetLocalVarNode;69;-1351.462,172.6721;Inherit;False;66;ss;1;0;OBJECT;;False;1;SAMPLERSTATE;0
Node;AmplifyShaderEditor.GetLocalVarNode;60;-875.5426,-492.8514;Inherit;False;77;heightUV;1;0;OBJECT;;False;1;FLOAT2;0
Node;AmplifyShaderEditor.GetLocalVarNode;67;-866.9569,-407.8983;Inherit;False;66;ss;1;0;OBJECT;;False;1;SAMPLERSTATE;0
Node;AmplifyShaderEditor.GetLocalVarNode;62;-1358.768,90.22866;Inherit;False;77;heightUV;1;0;OBJECT;;False;1;FLOAT2;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;58;-1810.035,-536.0821;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ParallaxOffsetHlpNode;64;-2140,22.21488;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT3;0,0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.GetLocalVarNode;72;-2761.77,-96.64952;Inherit;False;59;mainUV;1;0;OBJECT;;False;1;FLOAT2;0
Node;AmplifyShaderEditor.GetLocalVarNode;73;-2753.184,-11.6965;Inherit;False;66;ss;1;0;OBJECT;;False;1;SAMPLERSTATE;0
Node;AmplifyShaderEditor.ViewDirInputsCoordNode;74;-2442.719,189.5115;Inherit;False;Tangent;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.SimpleAddOpNode;76;-1862.275,-0.02097726;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;77;-1698.131,3.363943;Inherit;False;heightUV;-1;True;1;0;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;70;-2429.178,93.053;Inherit;False;Property;_HeightScale;HeightScale;8;0;Create;True;0;0;0;False;0;False;0.05;0.05;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;78;-2086.946,-65.53127;Inherit;False;59;mainUV;1;0;OBJECT;;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SamplerNode;71;-2542.556,-108.3254;Inherit;True;Property;_HeightMap;HeightMap;4;1;[NoScaleOffset];Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;10;7;67;0
WireConnection;15;0;22;0
WireConnection;15;1;13;0
WireConnection;21;0;55;2
WireConnection;21;1;18;0
WireConnection;13;0;55;4
WireConnection;19;1;61;0
WireConnection;19;5;20;0
WireConnection;19;7;68;0
WireConnection;59;0;58;0
WireConnection;55;1;62;0
WireConnection;55;7;69;0
WireConnection;66;0;65;0
WireConnection;58;0;57;0
WireConnection;64;0;71;3
WireConnection;64;1;70;0
WireConnection;64;2;74;0
WireConnection;76;0;78;0
WireConnection;76;1;64;0
WireConnection;77;0;76;0
WireConnection;71;1;72;0
WireConnection;71;7;73;0
ASEEND*/
//CHKSM=C84FCB0FFEC0B0AF3C9CFF5445C07558B352F965